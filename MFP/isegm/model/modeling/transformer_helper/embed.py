...
class PatchEmbed(nn.Module):
    """Image to Patch Embedding V2 (Pure PyTorch Version).

    Args:
        in_channels (int): Number of input channels. Default: 3
        embed_dims (int): Output embedding dimension. Default: 768
        kernel_size (int): Conv kernel size. Default: 16
        stride (int): Conv stride. Default: kernel_size
        padding (int): Conv padding. Default: 0
        dilation (int): Conv dilation. Default: 1
        pad_to_patch_size (bool): Whether to pad input to fit patch size. Default: True
