...
def parse_args():
    ...
    group_checkpoints.add_argument('--checkpoint', type=str, default='./weights/mfp_models/MFP_vit_base.pth',
    ...
    if args.cpu:
        jt.flags.use_cuda = 0  # 关闭 CUDA，使用 CPU
    else:
        jt.flags.use_cuda = 1  # 开启 CUDA，Jittor 会自动选择 GPU
