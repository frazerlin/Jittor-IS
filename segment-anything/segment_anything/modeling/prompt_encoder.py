...
class PromptEncoder(nn.Module):
    ...
    def get_dense_pe(self) -> jt.Var:
        ...
        Returns:
          jt.Tensor: Positional encoding with shape
    ...
    def execute(
        ...
        Arguments:
          points (tuple(jt.Tensor, jt.Tensor) or none): point coordinates
            and labels to embed.
          boxes (jt.Tensor or none): boxes to embed
          masks (jt.Tensor or none): masks to embed

        Returns:
          jt.Tensor: sparse embeddings for the points and boxes, with shape
            BxNx(embed_dim), where N is determined by the number of input points
            and boxes.
          jt.Tensor: dense embeddings for the masks, in the shape
